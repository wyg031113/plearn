...
\usemintedstyle[sh]{vs} %查看支持的样式：命令行中执行pygmentize -L styles; 支持的语言： pygmentize -L lexers
\renewcommand{\theFancyVerbLine}{\sffamily\textcolor[rgb]{0.6,0.2,0.3}{\normalsize\oldstylenums{\arabic{FancyVerbLine}}}}

\section{ETCD启动参数}
{\noindent etcd配置参数}\label{code_appendix_etcd_help}
\begin{minted}[linenos,firstnumber=1, fontfamily=tt, baselinestretch=0.7, numberblanklines=false, style=vs,xleftmargin=20pt,breaklines]{sh}
